...
That is the whole install: the add command and one setup run. Then log out and back in once, or start the listener by hand as shown below, because Hyprland runs autostart lines only at login.
