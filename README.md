...
After updating, save your work, close all existing distraction-browser windows, and reopen them through `distractions open`. A running browser keeps its old process scope and audio environment; a second launch hands off to that instance. The plugin never closes those windows for you.
