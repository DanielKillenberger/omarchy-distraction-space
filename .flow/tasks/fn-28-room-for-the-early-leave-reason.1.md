...
**Files:** ds/ui.py, tests/test_ui.py, README.md
**Touches:** ds/ui.py, tests/test_ui.py, README.md

### Quick commands
PATH=/usr/bin:$PATH python3 -m unittest tests.test_ui tests.test_lock
